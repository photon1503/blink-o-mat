...
- **Preview window "Open in Explorer" link click crash** — clicking **Open in File Explorer** no longer throws when the mouse event originates from a `Hyperlink`, because parent traversal now supports non-visual WPF content elements.
